...
//std::tuple<std::vector<double>, std::vector<double>> populatedxdymatrix(const SPinLocation* pinLocations);
std::vector<double> conjugateGradientSolver(const std::vector<std::vector<double>>& QMatrix, const std::vector<double>& rhs);
